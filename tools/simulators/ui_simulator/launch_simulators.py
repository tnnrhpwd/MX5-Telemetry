...
def main():
    ...
    print("=" * 60)
    print()
    print("Keyboard Controls (same for both simulators):")
    print("  M/Tab     = MODE (switch screens/device focus)")
    print("  Enter     = SELECT / CONFIRM")
    print("  Esc/B     = CANCEL / BACK")
    print("  ↑/W       = UP / RES+")
    print("  ↓/S       = DOWN / SET-")
    print("  →/D       = RIGHT / SEEK UP")
    print("  ←/A       = LEFT / SEEK DOWN")
    print("  +/=       = VOL+")
    print("  -         = VOL-")
    print("  Space     = MUTE (sleep toggle)")
    print("  D/T       = Toggle demo mode")
    print()
    print("=" * 60)
